...
// Define the type for payment status update
...
export function InstructorPaymentSuccessPage() {
                ...
                <div className="bg-white rounded-lg shadow px-8 py-12">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                            Bạn đã hoàn tất bước thanh toán để trở thành Instructor. Hãy sẵn sàng chia sẻ kiến thức và
                            truyền cảm hứng cho học viên nhé!
                        </p>
                    </div>
