...
export const CourseCard: React.FC<CourseCardProps> = ({
    ...
    <div className="border flex flex-col justify-between relative h-full bg-white rounded-lg transform transition duration-500 hover:scale-105 hover:shadow-xl">
